...
public class GoogleDriveHook {
    private static final String APPLICATION_NAME = "Drive The Band";
    ...
    public GoogleDriveHook() throws IOException, GeneralSecurityException {
